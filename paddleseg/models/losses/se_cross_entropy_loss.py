...
class SeCrossEntropyLoss(nn.Layer):
    ...
    def forward(self, logit, label):
        if logit.ndim == 4:
            ...
            assert logit_.ndim == 2, "The shape of logit should be [N, C, 1, 1] or [N, C], but got {}.".format(logit.ndim)
            logit = logit_
        assert logit.ndim == 2, "The dimension of logit should be 2, but got {}.".format(logit.ndim)
